...
parser.add_argument(
    '--flame_model_path',
    type = str,
    default = '/data/WX/fdm/FLAME_PyTorch/model/generic_model.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = '/data/WX/fdm/FLAME_PyTorch/model/flame_static_embedding.pkl',
...
parser.add_argument(
    ...
    type = str,
    default = '/data/WX/fdm/FLAME_PyTorch/model/flame_dynamic_embedding.npy',
