...
def get_dataloaders(batch_size=64, workers=10, read_audio=True):
    dataset = {}
    ...
    train_dataset = data.DataLoader(dataset=train_data, batch_size=batch_size, shuffle=True, num_workers=workers)

    valid_data = Dataset(valid_data, subjects_dict,"val",read_audio)
    valid_dataset = data.DataLoader(dataset=valid_data, batch_size=1, shuffle=False, num_workers=workers)

    test_data = Dataset(test_data, subjects_dict,"test",read_audio)
    test_dataset = data.DataLoader(dataset=test_data, batch_size=1, shuffle=False, num_workers=workers)
