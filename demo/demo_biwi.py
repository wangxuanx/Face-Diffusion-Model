...
def predict(diffusion, autoencoder, dev, audio_path, args):
    ...
    id_one_hot = torch.FloatTensor([1, 0, 0, 0, 0, 0, 0])
    ...
    result = diffusion.sample(audio, (1, num_frames * 8, 64), id_one_hot)
...
def get_args():
    ...
    parser.add_argument("--vertice_dim", type=int, default=23370*3, help='number of vertices')
    parser.add_argument("--feature_dim", type=int, default=1024, help='the fdm feature dimension')
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--template_file", type=str, default="templates.pkl", help='path of the personalized templates')
    parser.add_argument("--stage1_model_path", type=str, default="biwi/biwi_stage1.mpt", help='path of the stage 1 pretrained models')
    parser.add_argument("--stage2_model_path", type=str, default="biwi/biwi_stage2.mpt", help='path of the stage 2 pretrained models')
    parser.add_argument("--audio_path", type=str, default="biwi/result", help='path to the predictions')
