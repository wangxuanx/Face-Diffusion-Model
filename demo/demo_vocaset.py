...
def get_args():
    ...
    parser.add_argument("--stage1_model_path", type=str, default="vocaset/vocaset_stage1.mpt", help='path of the stage 1 pretrained models')
    parser.add_argument("--stage2_model_path", type=str, default="vocaset/vocaset_stage2.mpt", help='path of the stage 2 pretrained models')
    parser.add_argument("--audio_path", type=str, default="vocaset/result", help='path to the predictions')
